...
object MarkdownRenderer {
    ...
    private const val CODE_BG_COLOR = 0x55333355.toInt()      // 半透明深紫灰
    private const val CODE_BLOCK_BG_COLOR = 0xAA1A1A2E.toInt() // 代码块更深
    private const val LINK_COLOR = 0xFF5A8DEF.toInt()          // 品牌色
